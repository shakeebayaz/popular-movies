...
import com.digital.ayaz.data.MoviesContract.MovieEntry;
import com.digital.ayaz.data.MoviesContract.MovieReviewEntry;
import com.digital.ayaz.data.MoviesContract.MovieTrailerEntry;

/**
 * Created by Shakeeb on 7/10/2016.
 */
public class MoviesDbHelper extends SQLiteOpenHelper {
    ...
    public static ContentValues populateContentValue(Movie movie) {
        ContentValues values = new ContentValues();
        values.put( MovieEntry.COLUMN_MOVIE_ID, movie.getId());
        values.put(MovieEntry.COLUMN_IS_ADULT, movie.isAdult());
        values.put(MovieEntry.COLUMN_BACK_DROP_PATH, movie.getBackdropPath());
        ...
        values.put(MovieEntry.COLUMN_IS_VIDEO, movie.isVideo());
